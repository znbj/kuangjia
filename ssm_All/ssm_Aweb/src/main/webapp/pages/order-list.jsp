							...
							<c:forEach items="${pageInfo.list}" var="order">
								...
								<tr>
									...
									<td class="text-center">
										...
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/order/updateUI?id=${order.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
												onclick='location.href="${pageContext.request.contextPath}/order/del?id=${order.id}"'>删除</button>
									</td>
								</tr>
	...
	<script type="text/javascript">
        function gotoPage(pageNum) {
            ...
            if (pageNum >= 1 && pageNum <=${pageInfo.pages}){
                location.href="${pageContext.request.contextPath}/order/findByPageHelper?pageNum="+num+"&pageSize="+pageSize;
            }
        }
