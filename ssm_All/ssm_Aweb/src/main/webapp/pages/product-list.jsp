...
<head>
    ...
    <link rel="shotcut icon" href="${pageContext.request.contextPath}/img/bitbug_favicon.ico">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/indexqqq.jsp"><i
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <!--工具栏/-->
                        <form id="delForm" action="${pageContext.request.contextPath}/product/delProducts">
                            <!--数据列表-->
                            <table id="dataList"
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            共${pageInfo.pages}页，共${pageInfo.total}条数据。 每页
                    ...
                    <div class="box-tools col-lg-pull-10">
                        <ul class="pagination">
...
<script type="text/javascript">
    ...
    function gotoPage(pageNum) {
        ...
        if (pageNum >= 1 && pageNum <=${pageInfo.pages}) {
            location.href = "${pageContext.request.contextPath}/product/findByPageHelper?pageSize=" + pageSize + "&pageNum=" + pageNum;
        }
    }
